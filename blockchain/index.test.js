    ...
    describe("when the chain starts with the gensis block and has multiple blocks", () => {
      ...
      describe("and the chain contains a block with a jumped difficulty", () => {
        it("returns false", () => {
          ...
          const hash = cryptoHash(timestamp, difficulty, lastHash, nonce, data);
      ...
      describe("and the chian does not contain any invalid blocks", () => {
        it("returns true", () => {
